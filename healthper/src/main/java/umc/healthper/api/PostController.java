...
public class PostController {
    ...
    @Operation(summary = "게시글 목록 조회",
            description = "`posdId`에 해당하는 게시글을 조회합니다.\n\n" +
                    "댓글과 대댓글 목록도 함께 반환됩니다.")
    @GetMapping("/posts")
    ...
    @Operation(summary = "게시글 수정",
            description = "게시글 수정에 관한 데이터들을 전달받아 `posdId`에 해당하는 게시글을 수정합니다.")
    ...
    @Operation(summary = "게시글 삭제",
            description = "`posdId`에 해당하는 게시글을 삭제합니다.\n\n" +
